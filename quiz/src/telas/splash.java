...
public class splash extends javax.swing.JFrame {
                ...
                for (int i=0; i<=101; i++)
            {
                try{
                    ...
                    if (jBarra.getValue()<=30){
                        ...
                        if (jBarra .getValue()<=60){
                            jmsg.setText("Abrindo o jogo e carregando Banco de dados..");
    ...
    private void initComponents() {
        ...
        jmsg.setForeground(new java.awt.Color(255, 51, 0));
        ...
        jLbackground.setBounds(0, 0, 730, 470);
